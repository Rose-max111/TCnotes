...
For simplicity, we will focus on the 1D 110 rule elementary CA in the rest of this paper.
...
\begin{figure}[h]
    ...
    \caption{Time v.s. Depth of the material\jinguo{show a comparison from right to left}\jinguo{I have already used D as the dimension}}
\end{figure}
