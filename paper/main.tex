...
The state transition of the CA can be represented by a logic gate, which is encoded in the unit cell of the grid.
Each unit cell is associated with an energy model, which is an Ising model in our case. The ground state of which is associated with the state transition encoded in the logic gate.
