...
However, if we use the moving temperature gradient method, the system can thermalize in time almost linear to the size of the crystal, i.e. just like a normal computer.
