...
\ym{I am not sure about how to give a concrete definition of the effective width $W'$.}\jinguo{How about this?}
We have $\log(\Lambda) cW' \sim \log(\frac{T_{\rm max}}{\Delta E}\log(\frac{1}{\epsilon}))$.

Combining with \Cref{eq:totaltime}, the total annealing time can be estimated as
\begin{equation}
