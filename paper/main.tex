...
To overcome the overlap gap property, we propose to cool the system piece by piece, by introducing a heat zone with width $W$.
...
\subsubsection{Testing model with non-equilibrium simulated annealing}\label{some-details-about-non-equilibrium-simulated-annealing}\jinguo{Suggested subtitle: Simulating temperature gradient}
